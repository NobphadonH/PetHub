                    ...
                    >
                        {showPassword ? (
                            <svg width="24px" height="24px" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path clipRule="evenodd" d="M17.7469 15.4149C17.9855 14.8742 18.1188 14.2724 18.1188 14.0016C18.1188 11.6544 16.2952 9.7513 14.046 9.7513C11.7969 9.7513 9.97332 11.6544 9.97332 14.0016C9.97332 16.3487 12.0097 17.8886 14.046 17.8886C15.3486 17.8886 16.508 17.2515 17.2517 16.2595C17.4466 16.0001 17.6137 15.7168 17.7469 15.4149ZM14.046 15.7635C14.5551 15.7635 15.0205 15.5684 15.3784 15.2457C15.81 14.8566 16 14.2807 16 14.0016C16 12.828 15.1716 11.8764 14.046 11.8764C12.9205 11.8764 12 12.8264 12 14C12 14.8104 12.9205 15.7635 14.046 15.7635Z" fill="#000000" fillRule="evenodd"/>
                                <path clipRule="evenodd" d="M1.09212 14.2724C1.07621 14.2527 1.10803 14.2931 1.09212 14.2724C0.96764 14.1021 0.970773 13.8996 1.09268 13.7273C1.10161 13.7147 1.11071 13.7016 1.11993 13.6882C4.781 8.34319 9.32105 5.5 14.0142 5.5C18.7025 5.5 23.2385 8.33554 26.8956 13.6698C26.965 13.771 27 13.875 27 13.9995C27 14.1301 26.9593 14.2399 26.8863 14.3461C23.2302 19.6702 18.6982 22.5 14.0142 22.5C9.30912 22.5 4.75717 19.6433 1.09212 14.2724ZM3.93909 13.3525C3.6381 13.7267 3.6381 14.2722 3.93908 14.6465C7.07417 18.5443 10.6042 20.3749 14.0142 20.3749C17.4243 20.3749 20.9543 18.5443 24.0894 14.6465C24.3904 14.2722 24.3904 13.7267 24.0894 13.3525C20.9543 9.45475 17.4243 7.62513 14.0142 7.62513C10.6042 7.62513 7.07417 9.45475 3.93909 13.3525Z" fill="#000000" fillRule="evenodd"/>
                            </svg>
                        ) : (
                            <svg width="24px" height="24px" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div>
            ...
            <div className="flex flex-col mt-24">
                <div className="text-black font-bold text-3xl">ลงทะเบียน</div>
                <div className="flex flex-col justify-center items-center mt-10">
                    ...
                    <div className="flex items-center w-full max-w-sm mt-6">
                        ...
                        <span className="px-4 text-gray-500 text-sm">หรือใช้ตัวเลือกนี้</span>
                        <div className="flex-grow border-t border-gray-300"></div>
                    </div>
                    <button className="w-full max-w-sm bg-white text-gray-600 border border-base-300 mt-6 btn sm:btn-xs md:btn-sm lg:btn-md hover:text-white hover:bg-base-300 hover:border-base-300">
                    ...
                    <div className="text-gray-500 text-sm mt-4 mb-4">
                        มีบัญชีอยู่แล้ว? <a href="#" className="text-blue-500 font-medium hover:underline">ลงชื่อเข้าใช้</a>
                    </div>
                </div>
            </div>
        </div>
