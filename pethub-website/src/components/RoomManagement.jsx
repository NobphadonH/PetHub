  ...
  return (
    <>
     ...
     <div className="text-start my-8 lg:my-16 w-11/12 xl:w-10/12 max-w-[1200px] lg:h-full mx-auto rounded-md overflow-hidden border-[1px] p-[5vw] md:p-10 flex flex-col gap-4 ">
        <div className="font-bold text-[2.5vw] md:text-lg lg:text-2xl">รายการจองของ <span className="text-gray-400 font-light">ห้องขนาดทั่วไป (แมว)</span></div>
        ...
        <div className="w-full h-full border-[1px] rounded-md relative p-8 flex flex-col">
            <div className="absolute top-0 h-[1vw] md:h-2 w-4/12 bg-pethub-color1 left-4"></div>
            <div className="flex gap-20">
                <div className="font-semibold text-[2.5vw] md:text-lg lg:text-2xl">การจองเลขที่: <span className="text-gray-ุ00 font-light">B-987-6543210</span></div>
                <div className="font-semibold text-[2.5vw] md:text-lg lg:text-2xl">สถานะ: <span className="text-gray-400 font-light">รอการยืนยัน</span></div>
                <div className="font-semibold text-[2.5vw] md:text-lg lg:text-2xl">การจอง: <span className="text-gray-400 font-light">2 คืน</span></div>
            </div>
            <div className="my-4 text-[1.5vw] md:text-xs lg:text-sm">จองวันที่ 10 พฤศจิกายน 2567</div>
            ...
            <div className="flex w-full justify-between flex-wrap">
                <div>
                    ...
                    <input
                        ...
                        className="input input-bordered w-[35vw] sm:w-44 h-[8vw] max-h-10  text-[3vw] sm:h-10 xl:h-12 xl:w-52 sm:text-xs lg:text-sm bg-gray-100 mb-3"
                    />
                </div>
                <div>
            ...
            <div className="font-semibold text-[2vw] md:text-base lg:text-xl my-5">ข้อมูลสัตว์เลี้ยงที่เข้าพัก</div>
            <div>
            {Array.from({ length: 2}).map((_, index) => (
                <div id={index} key={index} className={` w-full relative h-28 sm:h-36 lg:h-40 xl:h-44 border-[1px] my-3 rounded-md p-1 flex`}>
            ...
            <div className="my-4 w-full flex justify-end gap-5">
